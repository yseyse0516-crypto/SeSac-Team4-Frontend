...
export function RouteComparisonTable({ routes }: RouteComparisonTableProps) {
  ...
  const [selected, setSelected] = useState<"fastest" | "recommended" | null>(null);
  ...
  const selectedRoute = selected === "fastest" ? fastest : selected === "recommended" ? recommended : null;
    ...
    <div className="route-comparison">
      <div className="route-comparison__summary">
        <button
          ...
          onClick={() => setSelected((v) => (v === "fastest" ? null : "fastest"))}
        >
        ...
        <button
          ...
          onClick={() => setSelected((v) => (v === "recommended" ? null : "recommended"))}
        >
      ...
      {selectedRoute && (
        <>
          ...
          <RouteDirections route={selectedRoute} />
        </>
      )}
